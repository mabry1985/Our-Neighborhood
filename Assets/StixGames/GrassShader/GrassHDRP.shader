Shader "Stix Games/Grass HDRP"
{
	Properties
	{
        ...
        SubShader
		{
			Tags{ "Queue" = "Opaque" "RenderPipeline"="HDRenderPipeline" "RenderType" = "StixGamesGrass" }
			LOD 1000
            ...
            Pass
            {
                ...
                #include "GrassIncludesHDRP.hlsl"
