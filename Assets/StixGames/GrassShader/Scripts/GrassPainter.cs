...
namespace StixGames.GrassShader
{
	...
	public class GrassPainter
	{
        ...
        /// <summary>
        /// The spacing isn't checked by the painter itself, you will have to restrict ApplyBrush calls on the outside.
        /// </summary>
		...
		public bool Draw(Ray ray)
		{
			...
			if (Physics.Raycast(ray, out hit))
			{
				...
				DensityTexture = hit.collider.GetComponent<Renderer>().material.GetTexture("_DensityTexture") as Texture2D;
